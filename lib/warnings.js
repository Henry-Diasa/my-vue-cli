...
module.exports = {
  v2SuffixTemplatesDeprecated(template, name) {
    ...
    console.log();
    console.log(
      chalk.yellow("  Please use this command instead: ") +
        chalk.green(initCommand)
    );
    console.log();
  },
  v2BranchIsNowDefault(template, name) {
    ...
    console.log(
      chalk.green("  This will install Vue 2.x version of the template.")
    );
    console.log();
    console.log(
      chalk.yellow("  For Vue 1.x use: ") + chalk.green(vue1InitCommand)
    );
    console.log();
  },
};
